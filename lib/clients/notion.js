...
class NotionClient extends BaseClient {
  ...
  _prepareUpdateData(update) {
    ...
    if (update["Onboarding Status"]) {
      data.properties["Onboarding Status"] = {
        "select": {
          "name": update["Onboarding Status"] 
        }
      }
    }
    if (update["Assigned Community Builder"]) {
      data.properties["Assigned Community Builder"] = {
        "relation":[
          {
              "id": update["Assigned Community Builder"]
          }
        ]
      }
    }
